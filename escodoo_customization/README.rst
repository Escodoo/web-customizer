...
restrict it to groups, or set modifiers. Duplicate names (for example
two ``email`` fields) are chosen in the dialog. That writes the same
ledger operations as the backend form.
