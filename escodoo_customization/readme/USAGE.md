...
3. On any form, click the magic-wand icon in the systray (customization
   ...
   it, **place an existing field** after it, hide it, change its label,
   set a widget, restrict it to groups, or set modifiers (invisible /
   readonly / required). The clicked field is the semantic anchor. To
